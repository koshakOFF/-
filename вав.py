...
from PyQt5.QtWidgets import QApplication, QWidget, QMainWindow, QPushButton, QInputDialog, QLineEdit, QFileDialog, QTabWidget,QVBoxLayout, QFileSystemModel
...
class MyTableWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.archButton = QPushButton('', self) # Кнопка архивациии
        self.archButton.setMinimumWidth(200)
        self.archButton.setMinimumHeight(50)
        self.archButton.move(80,200)
        self.archButton.setStyleSheet("background-image: url(2.png);")
